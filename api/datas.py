...
error_infos = {
	...
	'transactions_api_key_error':{'status': 500,'message': 'success','data': {'error':{'code':11,'message':'Invalid API key'}}},
	'transactions_error':{'status': 500,'message': 'success','data': {'error':{'code':10,'message':'transactions error or invaild address'}}}
}
